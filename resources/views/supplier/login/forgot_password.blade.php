    ...
    <div class="container mt--8 pb-5">
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-7">
                ...
                <div class="row mt-3">
                    <div class="col-6">
                        <a href="{{ route('supplier.login') }}" class="text-light"><small class='text-login-bold-white'>{{ trans('supplier.text_login') }}</small></a> / 
                    </div>
                    <div class="col-6 text-right">
                        <a href="{{ route('supplier.login.register') }}" class="text-light"><small class='text-login-bold-white'>{{ trans('supplier.button_create_account_nav') }}</small></a>
                    </div>
                </div>
            </div>
        </div>
