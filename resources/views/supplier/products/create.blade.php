                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="atributo_joias" id="atributo_joias" class="form-control">
                                                <option value="4006364" >Alpaca</option>
                                                <option value="4837600" >Aço</option>
                                                <option value="4006367" >Folheado a ouro</option>
                                                <option value="4006368" >Folheado a prata</option>
                                                <option value="2431881" >Madeira</option>
                                                <option value="2481971" >Ouro amarelo</option>
                                                <option value="2481973" >Ouro branco</option>
                                                <option value="4006366" >Ouro e platina</option>
                                                <option value="4006365" >Ouro e prata</option>
                                                <option value="2481972" >Ouro rosé</option>
                                                <option value="2787783" >Platina</option>
                                                <option value="2748302" >Plástico</option>
                                                <option value="2481975" >Prata</option>
                                                <option value="2832463" >Titânio</option>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="tipo_entrada" id="tipo_entrada" class="form-control">
                                                <option value="4027342" >DB25</option>
                                                <option value="2230456" >USB Tipo C</option>
                                                <option value="2230458" >Conector dock</option>
                                                <option value="2230457" >USB OTG</option>
                                ...
                                <div class="col-2">
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            ...
                                            <select name="atrib_phone_dualsim" id="atrib_phone_dualsim" class="form-control">
                                                <option value="242085" 'selected'>Sim</option>
                                                <option value="242084">Não</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="atrib_qtd_menint" class="form-control form-control-alternative" name="atrib_qtd_menint" placeholder="Qtd Memoria Interna">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="atrib_qtd_ram" class="form-control form-control-alternative" name="atrib_qtd_ram" placeholder="Qtd Memoria Ram" >
                                        </div>
                                    </div>
                            ...
                            <div class="col-2">
                                    ...
                                    <label class="form-control-label">Cor</label>
                                            <select name="atrib_phone_cor" id="atrib_phone_cor" class="form-control">
                                                <option value="52055" 'selected' >Branco</option>
                                                <option value="52028"  >Azul</option>
                                                <option value="51993"  >Vermelho</option>
                                                <option value="283165" >Cinza</option>
                                                <option value="52049"  >Preto</option>
                                                <option value="51994"  >Rosa</option>
                                                <option value="52014"  >Verde</option>
                                                <option value="283164" >Dourado</option>
                                                <option value="52019"  >Verde Escuro </option>
                                                <option value="283160" >Azul Turquesa</option>
                                                <option value="52022"  >Agua</option>
                                                <option value="283162" >Indigo</option>
                                                <option value="52036"  >Lavanda</option>
                                                <option value="283163" >Rosa Chiclete</option>
                                                <option value="51998"  >Bordo</option>
                                                <option value="52003"  >Nude</option>
                                                <option value="283161" >Azul Marinho</option>
                                                <option value="52008"  >Creme</option>
                                                <option value="52045"  >Rosa Palido</option>
                                                <option value="283153" >Palha</option>
                                                <option value="283150" >laranja Claro</option>
                                                <option value="52043"  >Rosa Claro</option>
                                                <option value="283148" >Cloral Claro</option>
                                                <option value="283149" >Coral</option>
                                                <option value="52021"  >Azul Celeste</option>
                                                <option value="52031"  >Azul Aço</option>
                                                <option value="283156" >Caqui</option>
                                                <option value="52001"  >Bege</option>
                                                <option value="52035"  >Violeta</option>
                                                <option value="283154" >Marom Claro</option>
                                                <option value="283155" >Marom Escuro</option>
                                ...
                                <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <select name="atrib_phone_oper" id="atrib_phone_oper" class="form-control">
                                                <option value="298335" 'selected'>Desbloqueado</option>
                                                <option value="298333" 'selected'>Claro</option>
                                                <option value="303172" 'selected'>Nextel</option>
                                                <option value="298334" 'selected'>TIM</option>
                                                <option value="298331" 'selected'>Oi</option>
                                                <option value="298332" 'selected'>Vivo</option>
