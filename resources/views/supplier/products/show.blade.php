                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless variant-fields-table">
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-alternative" name="new_variants[0][sku_secondary]" placeholder="{{ __('supplier.secondary') }}" value="{{ $variant->sku_secondary }}" readonly>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
