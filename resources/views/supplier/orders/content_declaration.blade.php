...
<html>
<head>
    <title>{{config('app.name')}} - {{ trans('supplier.text_declaracao_conteudo_pedido') }} {{ $supplier_order->display_id }}</title>
            ...
            <tbody>
                <tr>
                    <td colspan="4" style="white-space: normal; text-align: justify;">
                        <p style="font-size: 0.8rem">{{ trans('supplier.text_declaracao_enquadramento') }} </p>
