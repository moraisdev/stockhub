                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-4 mb-2 mb-xl-0 btn mr-0 bg-plan">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group text-center">
                                        <a href="{{route('shop.plans.selected', $plano->id)}}"  class="btn btn-primary">Assine Agora</a>
                                        </div>
                                    </div>                    
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 mb-2 mb-xl-0 btn mr-0 bg-plan-anual pt-4 pb-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <a href="{{route('shop.plans.selected', $plano->id)}}" class="btn btn-secondary" >Assine Agora</a>
                                        </div>
                                    </div>                    
                                </div>
                            </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6 mb-5 mb-xl-0">
                                <div class="form-group">
                                    <h2 class="mb-4 text-center">Tudo que você Lojista precisa está aqui:</h4>
                                    <p><i class="fa fa-check"></i> Facilita as transações comerciais por usar apenas a moeda brasileira, e não o dólar (para drop nacional);</p>
                                    <p><i class="fa fa-check"></i> Otimiza as operações logísticas, devido às menores distâncias;</p>
                                    <p><i class="fa fa-check"></i> Opera com um tempo menor de entrega do produto ao cliente;</p>
                                    <p><i class="fa fa-check"></i> Tem uma operação de trocas dentro do território nacional;</p>
                                    <p><i class="fa fa-check"></i> Não paga impostos de importação.</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-5 mb-xl-0">
                            <div class="form-group">
                                    <h2 class="mb-4 text-center">Características das assinaturas:</h4>
                                    <p><i class="fa fa-check"></i> Excelentes Prazos de entrega;</p>
                                    <p><i class="fa fa-check"></i> Preços menores ou similares ao do Aliexpress;</p>
                                    <p><i class="fa fa-check"></i> Tudo automatizado, assim como Dsers e Oberlo;</p>
                                    <p><i class="fa fa-check"></i> Produtos validados de alta conversão;</p>
                                    <p><i class="fa fa-check"></i> Fornecedores com menor preço e maior margem de lucros;</p>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group text-center">
                                <a href='{{route('shop.plans.selected', ['plan_id' => $plano->Id])}}' class="btn btn-primary" style="color: #fff;"><i class="fas fa-check-circle"></i> Selecionar Plano</a>
                            </div>
                        </div>
                    </div>
                </div>
