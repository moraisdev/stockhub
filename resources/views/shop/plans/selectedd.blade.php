                        ...
                        <form method="POST" action="{{route('shop.plans.store')}}" id='form-store-plan'>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="responsible_name" placeholder="{{ trans('supplier.nome_responsavel_empresa') }}" value="{{ $authenticated_user->responsible_name }}">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                @if($authenticated_user->token_card)
                                    <div class="col">
                                        <div class="form-group">
                                            <p>Você já forneceu os dados de pagamento. Caso queira alterar os dados do cartão, vá até <b><a href='{{route('shop.settings.index')}}'>{{ trans('supplier.configuracoes_title') }}</b></a> e remova o cartão antigo, após isso basta voltar aqui e fornecer os dados do novo cartão de crédito.</p>
                                        </div>
                                    </div>
                                @else
                                    <div class="col">
                            ...
                            <div class="w-100 d-flex flex-wrap align-items-center justify-content-end">
                                <div class="form-group text-center">
                                    <a href='{{route('shop.plans.index')}}' class="btn btn-danger" style="color: #fff;"><i class="fas fa-times"></i> {{ trans('supplier.back') }}</a>
