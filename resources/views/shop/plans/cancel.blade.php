                    ...
                    <div class="card-body">
                        <div class="row justify-content-center mb-4">
                            <div class='col-md-6 text-center' id='full-text-plan'>
                                ...
                                {{-- <small>Você tem 14 dias para usúfruir a nossa plataforma</small> --}}
                        ...
                        <form action="{{route('shop.plans.store.cancel')}}" method='post'>
                            @csrf
                            ...
                            <div class="w-100 d-flex flex-wrap align-items-center justify-content-center">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <select name="option_cancel" id="option_cancel" class='form-control'>
                                            <option value="Não encontro os produtos que gostaria">Não encontro os produtos que gostaria</option>
                                            <option value="Valor alto dos produtos pelos quais me interessei">Valor alto dos produtos pelos quais me interessei</option>
                                            <option value="Não estou fazendo mais Dropshipping Nacional">Não estou fazendo mais Dropshipping Nacional</option>
                                            <option value="Optei por continuar trabalhando com outra ferramenta">Optei por continuar trabalhando com outra ferramenta</option>
                                ...
                                <div class="form-group text-center">
                                    <button type='submit' class="btn btn-success" style="color: #fff;"><i class="fas fa-shopping-cart"></i> Cancelar Plano</button>
                                </div>
                            </div>
                        </form>
                    </div>
