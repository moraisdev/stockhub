            ...
            <div class="col-lg-5 col-md-7">
                        ...
                        <form role="form" method="POST" action="{{ route('shop.login.forgot_password.post') }}">
                            ...
                            <div class="form-group mb-3">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control" placeholder="Digite seu email para recuperar sua senha" type="email" name="email" value="{{ old('email') }}" readonly>
                                </div>
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary my-4 btn-login-custom">Recuperar minha senha</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="row mt-3">
                    ...
                    <div class="col-6 text-right">
                        <a href="{{ route('shop.login.register') }}" class="text-light"><small class='text-login-bold-white'>Criar nova conta</small></a>
                    </div>
                </div>
            </div>
        </div>
