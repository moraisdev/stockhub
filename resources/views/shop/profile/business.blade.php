    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <h1 class="display-2 text-white">Negócios</h1>
            </div>
        </div>
    </div>
</div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fantasy_name" placeholder="Nome da sua empresa" value="{{ $authenticated_user->fantasy_name }}" required>
                                </div>
                ...
                <div class="card bg-secondary shadow mt-4">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Endereço da Empresa</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
