                                            ...
                                            <td class="after_option_td" variant_id="{{ $variant->id }}">
                                                <div class="form-group">
                                                    <div class="input-group input-group-alternative flex-nowrap mb-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-alternative decimal pl-2" name="variants[{{ $variant->id }}][price]" placeholder="{{ trans('supplier.money_price') }}v" value="{{ $variant->price }}" readonly>
                                                    </div>
                                                </div>
                                            </td>
