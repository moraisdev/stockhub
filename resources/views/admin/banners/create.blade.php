...
@section('title', config('app.name').' - '.trans('supplier.cadastrar_banner'))
...
<div class="header pb-6 pt-4 pt-lg-6 d-flex align-items-center" style="min-height: 400px;">
    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            ...
            <h1 class="display-2 text-white">{{ trans('supplier.cadastrar_banner') }}</h1>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="product_title" class="form-control form-control-alternative" name="name" placeholder="{{ trans('supplier.nome_banner') }}" value="{{ old('name') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            <label class="form-control-label" for="product_title">{{ trans('supplier.link') }}</label>
                                            <input type="text" id="product_title" class="form-control form-control-alternative" name="link" placeholder="{{ trans('supplier.link_banner') }}" value="{{ old('link') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex  justify-content-center">
                                    <div class="image-hover">
                                        ...
                                        <div class="middle">
                                            <button type="button" id="example_img_button" onclick="uploadImage()" class="btn btn-sm btn-primary">{{ trans('supplier.enviar_imagem') }}</button>
